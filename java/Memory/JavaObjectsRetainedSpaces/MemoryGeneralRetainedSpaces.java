...
public class MemoryGeneralRetainedSpaces implements Serializable {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		 * 64 bitte header 8 yerine 12 byte geri kalan ayný
		 * Eðer sadece 64 bit JVM de geçerli olan ve <32GB ram de çalýþan XX:-UseCompressedOops VM argý turn off yapýp sýkýþtýrmayý kapatýrsan
		 * 2*8 = 16 header ve member pointer, array elemanlarýna pointer, array length ve stackdeki adres ref deðerleri 8 bytes olur.
		 * String 1.7.0_06 sonrasý 1 hashcode int, 1 hash32 int ve char[] içerir (daha önce final deðilken artýk final dýr) 
		 */
		...
		// her inner obje kendi içinde 8 in katýna yuvarlanýp öyle toplanýyor. String 24 byte + char 12 byte round to 16 then 24 + 16 = 40
		...
		// 4. element null ve yer tutmuyor. (Ancak normal class var null da olsa 32 bitte 8 bytes, 64 bit non compress de 8 bytes yer ayýrýr. 64 bit compress de yer ayýrmaz.)
		arrStr[0] = "1";
		arrStr[1] = "2";
		arrStr[2] = "3";
		arrStr[3] = null;
