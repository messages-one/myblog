...
public class MailClient extends Authenticator {
	...
	public MailClient(String user, String host, boolean debug) {
		...
		props.put("mail.smtp.host", host);//localhost local TCP/IP monitorden izleyerek TLS /SSL (þifreli) farkýný görmek içi
//		props.put("mail.smtp.socketFactory.port", "465");//80
//		props.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory");
		props.put("mail.smtp.auth", "true");
		props.put("mail.smtp.port", "1125");//default portlar config.xml de deðiþmiþ durumda
