package memory.objects.heap.addresses;

import memory.direct.memory.DirectMemoryUtil;
...
public class MemoryUseAddress {
	...
	public static long addressOf(Object o) throws Exception {
		...
		// int addressSize = DirectMemoryUtil.unsafe.addressSize(); Bu compress 64 bit de bile 8 d�ner arrayIndexScale kullan
