...
//	private volatile long dummyLong7;
	...
	public static class Thread1Runnable implements Runnable {
		...
		public void run() {
			...
			while (--i != 0) {
				TestPadding.myVolatileValue1 = (int) i;
			}
			System.out.println("End of thread 1, last value of myVolatileValue is " + TestPadding.myVolatileValue1 + " it took " + (System.nanoTime() - start) + " nanoseconds");
		}
	}
	...
	public static class Thread2Runnable implements Runnable {
		...
		public void run() {
			...
			long i = NUM_OF_ITERATION;
			while (--i != 0) {
				TestPadding.myVolatileValue2 = (int) i;
			}
			System.out.println("End of thread 2, last value of myValue is " + TestPadding.myVolatileValue2 + " it took " + (System.nanoTime() - start) + " nanoseconds");
		}
	}
}
